...
ggplot(imdb2, aes(x = rating)) +
  geom_histogram(
    bins = 20,
    fill = "#E63946",      # rojo elegante
    color = "white",
    alpha = 0.9,
    linewidth = 0.3
  ) +
  labs(
    title = "Distribución de calificaciones IMDb (Top 100)",
    subtitle = "La mayoría de las películas se concentra entre los ratings más altos (8–9.5)",
    x = "Rating IMDb",
    y = "Frecuencia"
  ) +
  scale_x_continuous(
